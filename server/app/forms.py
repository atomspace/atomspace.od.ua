...
class EditMerch(forms.Form):
    name = forms.CharField(label='Name', widget=forms.TextInput(
        attrs={'class': 'input-group-text'}), required=False)
    price = forms.IntegerField(label='Price', widget=forms.NumberInput(
        attrs={'class': 'input-group-text'}), required=False)
...
class LoginForm(forms.Form):
    username = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'input-group-item', 'placeholder': 'Username:'}))
    password = forms.CharField(widget=forms.TextInput(
        attrs={'class': 'input-group-item', 'placeholder': 'Password:', 'type': 'password'}))
